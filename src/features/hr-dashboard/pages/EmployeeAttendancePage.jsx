...
const EmployeeAttendancePage = () => {
  ...
  return (
    <div className="h-full overflow-y-auto px-4 md:px-6 py-4" dir="rtl">
      {/* زر رجوع */}
      <button
        onClick={() => navigate("/employees")}
      ...
      <div className="flex justify-center mb-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 bg-[#E9E8E84D] w-full md:w-[85%] p-4 rounded-xl">
          {/* كارت الإجازات */}
          <div className=" relative w-full h-32 bg-[#FF98311A] px-6 py-4 rounded-xl shadow flex flex-col items-start text-right">
           <div
    className="absolute bottom-0 left-0 w-[40px] h-[40px] bg-[#410A5F0A] rounded-tr-full"
  ></div>
            <div className="mb-2">
              <svg
                width="35"
            ...
            <span className="text-2xl font-bold text-[#410A5F]">
              {data.totalLeaves}
            </span>
            <span className="text-[#410A5F] text-sm">أيام الإجازات المتاحة</span>
  ...
  ></div>
            <div className="mb-2">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <rect x="0.664062" width="40" height="40" rx="20" fill="#410A5F" />
                <path
            ...
            <span className="text-[#410A5F] text-sm">يوم الغياب</span>
          </div>
  ...
  ></div>
            <div className="mb-2">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <rect x="0.332031" width="40" height="40" rx="20" fill="#410A5F" />
                <path
            ...
            <span className="text-[#410A5F] text-sm">يوم التأخير</span>
          </div>
        </div>
      </div>

      {/* جدول الحضور */}
      <h2 className="text-xl font-bold mb-2 text-[#410A5F]">
      ...
      <div className="bg-[#D8D8D833] rounded-xl shadow overflow-hidden">
        <div className="overflow-x-auto">
          <table className="min-w-full text-center">
            <thead className="bg-gray-100 text-[#410A5F] sticky top-0 z-10">
              <tr>
